...
router.get("/species",(req,res)=>{
    ...
    extra='<h2>Some Species that have been extinct</h2><ul><li>Black Softshell Turtle.</li><li>Père Davids Deer</li><li>Hawaiian Crow.</li><li class="TrT0Xe">Franklin Tree</li><li class="TrT0Xe">Wyoming Toad.</li></ul>'
